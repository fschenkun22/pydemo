...
def print_full(qr_code='',text1='',text2='',text3=''):
    ...
    hDC.TextOut(int(get_setting('line_pos_x_0')),int(get_setting('line_pos_y_0')), text1)
    ...
    hDC.SelectObject(font)
    hDC.TextOut(int(get_setting('line_pos_x_1')),int(get_setting('line_pos_y_1')), text2)
    ...
    hDC.SelectObject(font)
    hDC.TextOut(int(get_setting('line_pos_x_2')),int(get_setting('line_pos_y_2')), text3)
